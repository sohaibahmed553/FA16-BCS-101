				...
				<PageHeader
					...
					title={
						<div style={{ marginLeft: "40px" }}>
							<p style={{ display: "inline", color: "white", fontSize: "30px" }}>brain</p>
							<b style={{ display: "inline", color: "white", fontSize: "30px" }}>Buster</b>
						</div>
					}
				/>
					...
					<Content>
						<Switch>
							...
							<Route
								exact
								path="/student"
								render={(props) => <Dashboard {...props} logedInStudent={this.props.student} />}
							/>
							...
							<Route
								...
								render={(props) => <FinalResult {...props} student={this.props.student} />}
							/>
