...
import { Col, Row, Breadcrumb, List, Typography, Modal, Button, message } from "antd";
...
class TakeQuiz extends Component {
	...
	onSubmitClick = (e) => {
		...
		if (
			...
			if (this.state.selecedValue === this.state.questions[this.state.i].Answer) {
				...
				<Row className="font">
					<Col span={19}>
						...
						>
							...
							/>
							<Row>
								{this.state.questions.length !== 0 && this.state.i < this.state.questions.length && (
									<QuestionSection
					...
					<Col span={5} style={{ backgroundColor: "White", padding: "0px" }}>
						...
						<List>
							<NextQuestions
								...
								textColor={"white"}
							/>
							<NextQuestions questions={this.state.questions} i={this.state.i + 3} color={"color1"} />
							<NextQuestions questions={this.state.questions} i={this.state.i + 4} color={"color1"} />
							<NextQuestions questions={this.state.questions} i={this.state.i + 5} color={"color1"} />
						</List>
